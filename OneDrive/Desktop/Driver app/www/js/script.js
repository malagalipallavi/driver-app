...
const firebaseConfig = {
  ...
  // Add your other config values here from Firebase console
};
const firebaseConfig = {
  apiKey:            "YOUR_API_KEY",
  ...
  storageBucket:     "college-bus-tracker-b94c6.appspot.com",
...
// Keep driver logged in permanently
...
function doLogin() {
  ...
  auth.signInWithEmailAndPassword(email, password)
    ...
    .catch(err => {
      errDiv.textContent = 'Wrong email or password';
      errDiv.style.display = 'block';
    });
}
/* ============================================================
